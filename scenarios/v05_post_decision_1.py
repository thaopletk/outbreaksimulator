...
for properties_filename, diseaseoutbreak_filename, identifier in previous_step_filenames:
    ...
    unique_output = f"05_after_decision_{decision_ver}"
    print(unique_output)
    ...
    if decision_ver == "1":
        ...
        resource_setting == "high"
        management_parameters = {"movement_restrictions": {"restricted_area": 5, "control_area": 30}}
    ...
    run_specific_branch(
        ...
        days_to_run_for,
        resource_setting,
        decision_ver=None,  # only relevant for v04
        vaccination=True,
    )
