...
for two_weeks_resource_setting, resource_setting, final_vaccination, final_version in [
    ...
    unique_output = f"{undetected_spread_version}_{detected_spread_version}_{two_weeks_version}_{two_weeks_resource_setting}_06_final_{final_version}_{resource_setting}_{final_vaccination}"
    ...
    # TODO check about adding in vaccination control zone - well, vaccination is currently the control areas, prioritising outer edges
    ...
    file_name = os.path.join(folder_path, "workshop_p3_map_apparent" + file_name_ending)
