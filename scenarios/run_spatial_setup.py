...
output.plot_map_land(property_coordinates, adjacency_matrix, neighbour_pairs, neighbourhoods, property_polygons, property_polygons_puffed,xrange, yrange,folder_path_main)